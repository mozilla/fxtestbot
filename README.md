...
webqabot is a chat bot built on the [Hubot][hubot] framework. It was
...
You can start webqabot locally by running:
...
Then you can interact with webqabot by typing `webqabot help`.
    ...
    webqabot animate me <query> - The same thing as `image me`, except adds [snip]
